...
from multimolecule.module import ContactPredictionHead, SequencePredictionHead, TokenPredictionHead
...
class RibonanzaNetEncoder(nn.Module):
    ...
    def forward(
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            if attention_mask is not None and not self.fix_attention_mask:
                attention_mask = (attention_mask_ == 1).float().clone() if i == 0 else attention_mask_
