...
- **[multimolecule/borzoi](https://huggingface.co/multimolecule/borzoi)**: human head.
- **[multimolecule/borzoi-mouse](https://huggingface.co/multimolecule/borzoi-mouse)**: mouse head.
...
The table reports the human output head. The mouse head predicts 2,608 tracks.
