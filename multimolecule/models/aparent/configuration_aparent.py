...
class AparentConfig(PreTrainedConfig):
    ...
    Args:
        ...
        conv1_channels:
            Number of output channels in the first convolution.
        conv1_kernel_size:
        ...
        conv2_channels:
            Number of output channels in the second convolution.
        conv2_kernel_size:
    ...
    Examples:
        ...
        >>> # Initializing an APARENT johli/aparent style configuration
