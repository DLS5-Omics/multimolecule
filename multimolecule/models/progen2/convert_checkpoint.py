...
def _split_qkv_weight(weight: torch.Tensor, hidden_size: int, mp_num: int = _QKV_MP_NUM):
...
def _split_qkv_bias(bias: torch.Tensor, hidden_size: int, mp_num: int = _QKV_MP_NUM):
