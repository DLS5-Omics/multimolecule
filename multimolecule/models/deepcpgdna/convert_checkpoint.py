...
# Upstream DeepCpG (Angermueller et al. 2017, cangermueller/deepcpg) encodes DNA through
# deepcpg.data.dna.CHAR_TO_INT = OrderedDict([("A", 0), ("T", 1), ("G", 2), ("C", 3), ("N", 4)]).
# The `N` channel is not present in the four-channel model input; it is encoded as all zeros.
ORIGINAL_VOCAB_LIST = ["A", "T", "G", "C"]
...
def convert_checkpoint(convert_config):
    ...
    if weight is not None:
        ...
        state_dict[key][:, new_vocab_list.index("N"), :] = 0
