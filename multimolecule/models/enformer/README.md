...
| ------------ | -------- | ----------- | ----------- | ------ | ----- | ---------- | ------------------ | --------- | -------- |
| 393216       | 128      | 896         | 1536        | 11     | 8     | 5313       | 246.18             | 10.50     | 5.23     |

The table reports the human output head. The mouse head predicts 1643 tracks.
FLOPs and MACs are measured on the canonical 393,216 bp Enformer input window.
