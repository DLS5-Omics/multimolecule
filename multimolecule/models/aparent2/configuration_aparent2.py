...
class Aparent2Config(PreTrainedConfig):
    ...
    [`Aparent2Model`][multimolecule.models.Aparent2Model]. It is used to instantiate an APARENT2 model according to the
    ...
    Examples:
        ...
        >>> # Initializing an APARENT2 multimolecule/aparent2 style configuration
