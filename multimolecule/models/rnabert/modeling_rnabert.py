...
class RnaBertLayer(nn.Module):
    def __init__(self, config: RnaBertConfig):
        ...
        if self.add_cross_attention:
            ...
            self.crossattention = RnaBertAttention(config, position_embedding_type="absolute")
...
class RnaBertAttention(nn.Module):
    ...
    def __init__(self, config: RnaBertConfig, position_embedding_type: str | None = None):
        super().__init__()
        self.self = RnaBertSelfAttention(config, position_embedding_type=position_embedding_type)
