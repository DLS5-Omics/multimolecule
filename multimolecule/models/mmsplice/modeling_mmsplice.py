...
LOGIT_CLIP = 1e-5
# Default DnaTokenizer ids reserve six special-token slots before A/C/G/T/N.
STANDARD_DNA_TOKEN_OFFSET = 6
...
class MmSpliceEmbedding(nn.Module):
    ...
    def _channel_ids(self, input_ids: Tensor) -> Tensor:
        ...
        if torch.any(channel_ids >= STANDARD_DNA_TOKEN_OFFSET):
            channel_ids = channel_ids - STANDARD_DNA_TOKEN_OFFSET
        return channel_ids
