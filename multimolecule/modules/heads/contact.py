...
class BaseContactPredictionHead(BasePredictionHead):
    r"""
    Base class for contact prediction heads.
    ...
    def symmetrize(self, x: Tensor) -> Tensor:
        r"""
...
class ContactPredictionHead(BaseContactPredictionHead):
    r"""
    ...
    def forward(  # type: ignore[override]  # pylint: disable=arguments-renamed
        ...
        **kwargs,
        ...
        output, _, _ = self.remove_special_tokens_2d(output, attention_mask, input_ids)
...
class ContactAttentionHead(BaseContactPredictionHead):
    r"""
    Head for tasks in contact-level.
    ...
    def forward(  # type: ignore[override]  # pylint: disable=arguments-renamed
        ...
        **kwargs,
        ...
        if isinstance(outputs, (Mapping, ModelOutput)):
            ...
            output = outputs[-1]
        attentions = torch.stack(output, 1) if isinstance(output, (list, tuple)) else output
        ...
        contact_map = attentions.view(batch_size, layers * heads, seqlen, seqlen).permute(0, 2, 3, 1)
