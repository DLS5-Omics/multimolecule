...
class RegulatorySequencePredictionPipeline(Pipeline):
    """
    Sequence-level regulatory prediction pipeline for DNA regulatory models.
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not isinstance(self.model, torch.nn.Module):
            raise NotImplementedError("Only PyTorch is supported for regulatory sequence prediction.")


class RegulatoryTrackPredictionPipeline(Pipeline):
    """
    Binned regulatory track prediction pipeline for DNA regulatory models.
...
class RegulatoryProfilePredictionPipeline(Pipeline):
    """
    Base-resolution regulatory profile prediction pipeline for DNA regulatory models.
