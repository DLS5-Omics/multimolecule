...
This License FAQ elucidates the terms and conditions governing the use of data, models, code, configurations, and documentation provided by the DanLing Team (also known as DanLing) ("we," "us," or "our"). It serves as an addendum to our _[License](license.md)_. Together, the License FAQ and the _[License](license.md)_ constitute the entire **Agreement** for individuals seeking to obtain a license.

## 0. Summary of Key Points

This summary highlights the key aspects of our license. For more detailed information, please refer to the corresponding sections below and read the _[License](license.md)_.
...
!!! question "Am I required to open-source my fine-tuned model weights?"
    ...
    Yes, any fine-tuned model weights derived from MultiMolecule's pre-trained models must be open-sourced under the **Agreement**.
...
Yes, if you utilize a pre-trained model from MultiMolecule's model hub and subsequently fine-tune it, you must open-source your modified model weights under the **Agreement**.
...
YES! MultiMolecule can be used for commercial purposes under the **Agreement**. Note that you must open-source any modifications to the source code and make them available under the **Agreement**.
...
No, federal employees of the United States Government cannot use MultiMolecule under the **Agreement** because code authored by U.S. federal employees is not protected by copyright under [17 U.S. Code § 105](https://www.law.cornell.edu/uscode/text/17/105).

As a result, federal employees are unable to comply with the terms of the **Agreement** and, therefore, cannot use MultiMolecule.
